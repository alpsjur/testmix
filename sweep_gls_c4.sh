...
for GLS_C4 in "${GLS_C4_VALUES[@]}"; do
    ...
    OUTPUT_HISNAME="output/gen_str_GLS_C4_${GLS_C4}_his.nc"
    ...
    # Run the ROMS model
    echo "Running ROMS with GLS_C4=${GLS_C4}..."
    ./romsS_str < $BASE_INPUT_FILE > "logs/gen_str_GLS_C4_${GLS_C4}.log"

    # Check if the run was successful
    if [ $? -ne 0 ]; then
        echo "Run failed for GLS_C4=${GLS_C4}. Check the log file."
    else
        echo "Run completed for GLS_C4=${GLS_C4}. Output: ${OUTPUT_HISNAME}"
    fi
done
